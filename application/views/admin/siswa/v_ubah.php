    ...
    <div class="card">
        <div class="container-fluid">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"> 
                <h3 class="page-header"><span> Ubah Data Siswa</span></h3>
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>','</div>');
                                        ...
                                        echo form_open_multipart('siswa/ubah/'.$siswa->id_siswa);
                                    ?>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" value="<?= $siswa->tgl_lahir ?>" name="tgl_lahir" placeholder="Tanggal Lahir" Required>
                                        </div>
                                    </div> 
                                    <div class="col-md-8">
                                        <div class="form-group">
