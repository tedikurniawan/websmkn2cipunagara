    ...
    <div class="card">
        <div class="container-fluid">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"> 
                <h3 class="page-header"><span> Tambah Data Mata Pelajaran</span></h3>
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <?php
                                        ...
                                        echo form_open_multipart('mapel/tambah');
                                    ?>
                                    <div class="card-body table-full-width table-responsive">
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label>Id Mata Pelajaran</label>
                                                <input class="form-control" type="text" name="id_mapel" placeholder="Id Mata Pelajaran" Required>
                                            </div>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="form-group">
